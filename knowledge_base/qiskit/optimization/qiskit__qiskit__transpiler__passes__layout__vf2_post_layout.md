...
source_path: qiskit/transpiler/passes/layout/vf2_post_layout.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/transpiler/passes/layout/vf2_post_layout.py
license: Apache-2.0
---

## Module `qiskit/transpiler/passes/layout/vf2_post_layout.py`
...
```python
def __init__(self, target=None, seed=None, call_limit=None, time_limit=None, strict_direction=True, max_trials=0)
```
