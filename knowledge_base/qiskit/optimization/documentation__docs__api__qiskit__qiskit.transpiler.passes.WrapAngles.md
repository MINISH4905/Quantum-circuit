...
source_path: docs/api/qiskit/qiskit.transpiler.passes.WrapAngles.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.WrapAngles.mdx
license: CC-BY-SA-4.0
---

# WrapAngles

<Class id="qiskit.transpiler.passes.WrapAngles" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/utils/wrap_angles.py#L21-L108" signature="qiskit.transpiler.passes.WrapAngles(*args, **kwargs)" modifiers="class">
  ...
  ![Circuit diagram of the output from running the WrapAngles pass](/docs/images/api/qiskit/qiskit-transpiler-passes-WrapAngles-1.avif)
  ...
  *   **registry** ([*WrapAngleRegistry*](qiskit.transpiler.WrapAngleRegistry "qiskit.transpiler.WrapAngleRegistry")) –
  ...
  <Attribute id="qiskit.transpiler.passes.WrapAngles.DEFAULT_REGISTRY">
    Default value: `<qiskit._accelerate.angle_bound_registry.WrapAngleRegistry object>`
  ...
  <Function id="qiskit.transpiler.passes.WrapAngles.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.WrapAngles.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.WrapAngles.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/utils/wrap_angles.py#L106-L108" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.WrapAngles.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
