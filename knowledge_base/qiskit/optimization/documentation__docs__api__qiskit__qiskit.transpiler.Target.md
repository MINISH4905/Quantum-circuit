...
source_path: docs/api/qiskit/qiskit.transpiler.Target.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.Target.mdx
license: CC-BY-SA-4.0
---

# Target

<Class id="qiskit.transpiler.Target" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L87-L950" signature="qiskit.transpiler.Target(description=None, num_qubits=0, dt=None, granularity=1, min_length=1, pulse_alignment=1, acquire_alignment=1, qubit_properties=None, concurrent_measurements=None, **_subclass_kwargs)" modifiers="class">
  Bases: `BaseTarget`
  ...
  As a basic example, let’s assume a backend has two qubits, supports [`UGate`](qiskit.circuit.library.UGate "qiskit.circuit.library.UGate") on both qubits and [`CXGate`](qiskit.circuit.library.CXGate "qiskit.circuit.library.CXGate") in both directions. To model this you would create the target like:
  ...
  **raises ValueError**
  ...
  <Function id="qiskit.transpiler.Target.add_instruction" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L363-L463" signature="add_instruction(instruction, properties=None, name=None, *, angle_bounds=None)">
  ...
  <Function id="qiskit.transpiler.Target.build_coupling_map" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L615-L681" signature="build_coupling_map(two_q_gate=None, filter_idle_qubits=False)">
  ...
  <Function id="qiskit.transpiler.Target.durations" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L498-L513" signature="durations()">
  ...
  <Function id="qiskit.transpiler.Target.from_configuration" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L783-L950" signature="from_configuration(basis_gates, num_qubits=None, coupling_map=None, instruction_durations=None, concurrent_measurements=None, dt=None, timing_constraints=None, custom_name_mapping=None)" modifiers="classmethod">
  ...
  <Function id="qiskit.transpiler.Target.gate_has_angle_bounds" signature="gate_has_angle_bounds(name)">
  ...
  <Function id="qiskit.transpiler.Target.get" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L697-L702" signature="get(key, default=None)">
    Gets an item from the Target. If not found return a provided default or None.
  </Function>

  ### get\_non\_global\_operation\_names

  <Function id="qiskit.transpiler.Target.get_non_global_operation_names" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L323-L350" signature="get_non_global_operation_names(strict_direction=False)">
  ...
  <Function id="qiskit.transpiler.Target.has_angle_bounds" signature="has_angle_bounds()">
  ...
  <Function id="qiskit.transpiler.Target.instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L545-L583" signature="instruction_properties(index)">
  ...
  <Function id="qiskit.transpiler.Target.instruction_supported" signature="instruction_supported(operation_name=None, qargs=Ellipsis, operation_class=None, parameters=None, check_angle_bounds=True)">
  ...
  <Function id="qiskit.transpiler.Target.items" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L718-L720" signature="items()">
    Returns pairs of Gate names and its property map (str, dict\[tuple, InstructionProperties])
  </Function>

  ### keys

  <Function id="qiskit.transpiler.Target.keys" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L710-L712" signature="keys()">
  ...
  <Function id="qiskit.transpiler.Target.operation_from_name" signature="operation_from_name(instruction)">
    ...
    **instruction** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) – The instruction name to get the [`Instruction`](qiskit.circuit.Instruction "qiskit.circuit.Instruction") instance for
  ...
  <Function id="qiskit.transpiler.Target.qargs_for_operation_name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L486-L496" signature="qargs_for_operation_name(operation)">
  ...
  <Function id="qiskit.transpiler.Target.seconds_to_dt" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L771-L781" signature="seconds_to_dt(duration)">
    Convert a given duration in seconds to units of dt

    **Parameters**

    **duration** ([*float*](https://docs.python.org/3/library/functions.html#float)) – The duration in seconds, such as in an [`InstructionProperties`](qiskit.transpiler.InstructionProperties "qiskit.transpiler.InstructionProperties") field for an instruction in the target.
  ...
  <Function id="qiskit.transpiler.Target.supported_angle_bound" signature="supported_angle_bound(name, angles)">
  ...
  <Function id="qiskit.transpiler.Target.timing_constraints" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L515-L523" signature="timing_constraints()">
  ...
  <Function id="qiskit.transpiler.Target.update_instruction_properties" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L465-L484" signature="update_instruction_properties(instruction, qargs, properties)">
  ...
  <Function id="qiskit.transpiler.Target.values" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/target.py#L714-L716" signature="values()">
