...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.mdx
license: CC-BY-SA-4.0
---

# QFTSynthesisFull

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L879-L936" signature="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.QFTSynthesisFull.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L914-L936" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
