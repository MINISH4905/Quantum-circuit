...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04.mdx
license: CC-BY-SA-4.0
---

# FullAdderSynthesisC04

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1974-L1987" signature="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.FullAdderSynthesisC04.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1983-L1987" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
