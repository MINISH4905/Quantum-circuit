...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisVChain.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisVChain.mdx
license: CC-BY-SA-4.0
---

# MCMTSynthesisVChain

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisVChain" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1612-L1629" signature="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisVChain" modifiers="class">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.MCMTSynthesisVChain.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1615-L1629" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
