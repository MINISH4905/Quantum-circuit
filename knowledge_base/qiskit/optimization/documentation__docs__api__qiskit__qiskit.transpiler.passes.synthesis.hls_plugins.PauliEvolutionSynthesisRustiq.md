...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq.mdx
license: CC-BY-SA-4.0
---

# PauliEvolutionSynthesisRustiq

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L2095-L2192" signature="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq" modifiers="class">
  ...
  **References**
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.PauliEvolutionSynthesisRustiq.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L2127-L2192" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
