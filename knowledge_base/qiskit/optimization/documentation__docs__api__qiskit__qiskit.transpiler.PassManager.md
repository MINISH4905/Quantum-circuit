...
source_path: docs/api/qiskit/qiskit.transpiler.PassManager.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.PassManager.mdx
license: CC-BY-SA-4.0
---

# PassManager

<Class id="qiskit.transpiler.PassManager" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L37-L233" signature="qiskit.transpiler.PassManager(passes=(), max_iteration=1000)" modifiers="class">
  ...
  *   **passes** ([*Task*](qiskit.passmanager.Task "qiskit.passmanager.Task")  *|*[*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Task*](qiskit.passmanager.Task "qiskit.passmanager.Task")*]*) – A pass set to be added to the pass manager schedule.
  *   **max\_iteration** ([*int*](https://docs.python.org/3/library/functions.html#int)) – The maximum number of iterations the schedule will be looped if the condition is not met.
  ...
  <Function id="qiskit.transpiler.PassManager.append" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L99-L111" signature="append(passes)">
  ...
  <Function id="qiskit.transpiler.PassManager.draw" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L204-L233" signature="draw(filename=None, style=None, raw=False)">
  ...
  <Function id="qiskit.transpiler.PassManager.remove" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/passmanager.py#L97-L109" signature="remove(index)">
  ...
  <Function id="qiskit.transpiler.PassManager.replace" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L113-L124" signature="replace(index, passes)">
    ...
    *   **passes** ([*Task*](qiskit.passmanager.Task "qiskit.passmanager.base_tasks.Task")  *|*[*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Task*](qiskit.passmanager.Task "qiskit.passmanager.base_tasks.Task")*]*) – A pass set to be added to the pass manager schedule.
  ...
  <Function id="qiskit.transpiler.PassManager.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passmanager.py#L126-L202" signature="run(circuits, output_name=None, callback=None, num_processes=None, *, property_set=None)">
  ...
  <Function id="qiskit.transpiler.PassManager.to_flow_controller" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/passmanager.py#L267-L275" signature="to_flow_controller()">
    ...
    **Return type**
    ...
    [*FlowControllerLinear*](qiskit.passmanager.FlowControllerLinear "qiskit.passmanager.flow_controllers.FlowControllerLinear")\[*IR*, *IR*]
  </Function>
</Class>
