...
source_path: docs/api/qiskit/qiskit.transpiler.passes.BasicSwap.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.BasicSwap.mdx
license: CC-BY-SA-4.0
---

# BasicSwap

<Class id="qiskit.transpiler.passes.BasicSwap" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/routing/basic_swap.py#L24-L174" signature="qiskit.transpiler.passes.BasicSwap(*args, **kwargs)" modifiers="class">
  ...
  *   **fake\_run** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if true, it will only pretend to do routing, i.e., no swap is effectively added.
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/routing/basic_swap.py#L49-L128" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.BasicSwap.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
