...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation.mdx
license: CC-BY-SA-4.0
---

# TokenSwapperSynthesisPermutation

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L990-L1066" signature="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation" modifiers="class">
  ...
  *   parallel\_threshold: The argument to the token swapper specifying the number of nodes in the graph beyond which the algorithm will use parallel processing.
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.TokenSwapperSynthesisPermutation.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1022-L1066" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
