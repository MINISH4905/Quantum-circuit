...
source_path: docs/api/qiskit/qiskit.transpiler.passes.DenseLayout.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.DenseLayout.mdx
license: CC-BY-SA-4.0
---

# DenseLayout

<Class id="qiskit.transpiler.passes.DenseLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/layout/dense_layout.py#L28-L168" signature="qiskit.transpiler.passes.DenseLayout(*args, **kwargs)" modifiers="class">
  ...
  *   **target** ([*Target*](qiskit.transpiler.Target "qiskit.transpiler.Target")) – A target representing the target backend.
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L76-L122" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.DenseLayout.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/layout/dense_layout.py#L54-L100" signature="run(dag)">
    ...
    **Raises**
    ...
    [**TranspilerError**](/docs/api/qiskit/transpiler#qiskit.transpiler.TranspilerError "qiskit.transpiler.TranspilerError") – if dag wider than self.coupling\_map
  </Function>

  ### update\_status

  <Function id="qiskit.transpiler.passes.DenseLayout.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L124-L142" signature="update_status(state, run_state)">
