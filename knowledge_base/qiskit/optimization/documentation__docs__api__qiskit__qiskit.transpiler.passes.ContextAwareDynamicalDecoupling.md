...
source_path: docs/api/qiskit/qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.mdx
license: CC-BY-SA-4.0
---

# ContextAwareDynamicalDecoupling

<Class id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L42-L641" signature="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling(*args, **kwargs)" modifiers="class">
  ...
  **\[2] A. Kosowski, and K. Manuszewski, Classical Coloring of Graphs, Graph Colorings,**
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.get_orthogonal_sequence" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L232-L235" signature="get_orthogonal_sequence(order)">
    ...
    **Return type**
    ...
    [tuple](https://docs.python.org/3/library/stdtypes.html#tuple)\[[list](https://docs.python.org/3/library/stdtypes.html#list)\[[float](https://docs.python.org/3/library/functions.html#float)], [list](https://docs.python.org/3/library/stdtypes.html#list)\[[*Gate*](qiskit.circuit.Gate "qiskit.circuit.gate.Gate")]]
  </Function>

  ### name

  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/scheduling/padding/context_aware_dynamical_decoupling.py#L164-L230" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.ContextAwareDynamicalDecoupling.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
