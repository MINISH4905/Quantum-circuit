...
<Class id="qiskit.transpiler.TranspileLayout" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L447-L975" signature="qiskit.transpiler.TranspileLayout(initial_layout, input_qubit_mapping, final_layout=None, _input_qubit_count=None, _output_qubit_list=None)" modifiers="class">
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-transpiler-TranspileLayout-1.avif)
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-transpiler-TranspileLayout-2.avif)
  ...
  (it is also this attribute in the [`QuantumCircuit.draw()`](/docs/api/qiskit/qiskit.circuit.QuantumCircuit#draw "qiskit.circuit.QuantumCircuit.draw") and [`circuit_drawer()`](qiskit.visualization.circuit_drawer "qiskit.visualization.circuit_drawer") which is used to display the mapping of qubits to positions in circuit visualizations post-transpilation).
  ...
  ![Circuit diagram output by the previous code.](/docs/images/api/qiskit/qiskit-transpiler-TranspileLayout-3.avif)
  ...
  *   **final\_layout** ([*Layout*](qiskit.transpiler.Layout "qiskit.transpiler.layout.Layout") *| None*)
  ...
  *   **\_output\_qubit\_list** ([*list*](https://docs.python.org/3/library/stdtypes.html#list)*\[*[*Qubit*](/docs/api/qiskit/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit")*] | None*)
  ...
  <Attribute id="qiskit.transpiler.TranspileLayout.final_layout">
    Type: [`Layout`](qiskit.transpiler.Layout "qiskit.transpiler.layout.Layout") | [`None`](https://docs.python.org/3/library/constants.html#None)
  ...
  <Attribute id="qiskit.transpiler.TranspileLayout.initial_layout">
    Type: [`Layout`](qiskit.transpiler.Layout "qiskit.transpiler.layout.Layout")
  </Attribute>

  ### input\_qubit\_mapping

  <Attribute id="qiskit.transpiler.TranspileLayout.input_qubit_mapping">
    Type: [`dict`](https://docs.python.org/3/library/stdtypes.html#dict)\[[`Qubit`](/docs/api/qiskit/circuit#qiskit.circuit.Qubit "qiskit.circuit.Qubit"), [`int`](https://docs.python.org/3/library/functions.html#int)]
  </Attribute>
  ...
  <Function id="qiskit.transpiler.TranspileLayout.final_index_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L629-L697" signature="final_index_layout(filter_ancillas=True)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.final_virtual_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L699-L745" signature="final_virtual_layout(filter_ancillas=True)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.from_property_set" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L747-L927" signature="from_property_set(dag, property_set)" modifiers="classmethod">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.initial_index_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L589-L611" signature="initial_index_layout(filter_ancillas=False)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.initial_virtual_layout" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L564-L587" signature="initial_virtual_layout(filter_ancillas=False)">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.routing_permutation" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L613-L627" signature="routing_permutation()">
  ...
  <Function id="qiskit.transpiler.TranspileLayout.write_into_property_set" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/layout.py#L929-L975" signature="write_into_property_set(property_set)">
