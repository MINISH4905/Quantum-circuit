...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.mdx
license: CC-BY-SA-4.0
---

# RossSelingerSynthesis

<Class id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L32-L114" signature="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis" modifiers="class">
  ...
  **\[1] Neil J. Ross, Peter Selinger, Optimal ancilla-free Clifford+T approximation of z-rotations,**
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.max_qubits">
    Maximum number of supported qubits is `1`.
  </Attribute>

  ### min\_qubits

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.min_qubits">
    Minimum number of supported qubits is `1`.
  </Attribute>

  ### supported\_bases

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supported_bases">
    The plugin does not support bases for synthesis.
  </Attribute>

  ### supports\_basis\_gates

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_basis_gates">
    The plugin does not support basis gates. By default it synthesizes to the `["h", "s", "t", "x"]` gate basis.
  </Attribute>

  ### supports\_coupling\_map

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_coupling_map">
    The plugin does not support coupling maps.
  </Attribute>

  ### supports\_gate\_errors

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_errors">
    The plugin does not support gate errors.
  </Attribute>

  ### supports\_gate\_errors\_by\_qubit

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_errors_by_qubit">
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_lengths">
    The plugin does not support gate lengths.
  </Attribute>

  ### supports\_gate\_lengths\_by\_qubit

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_gate_lengths_by_qubit">
  ...
  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_natural_direction">
    The plugin does not support natural direction, it does not assume bidirectional two qubit gates.
  </Attribute>

  ### supports\_pulse\_optimize

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_pulse_optimize">
    The plugin does not support optimization of pulses.
  </Attribute>

  ### supports\_target

  <Attribute id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.supports_target">
  ...
  <Function id="qiskit.transpiler.passes.synthesis.ross_selinger_plugin.RossSelingerSynthesis.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/ross_selinger_plugin.py#L104-L114" signature="run(unitary, **options)">
