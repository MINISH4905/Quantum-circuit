...
source_path: docs/api/qiskit/qiskit.transpiler.passes.CommutativeInverseCancellation.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.CommutativeInverseCancellation.mdx
license: CC-BY-SA-4.0
---

# CommutativeInverseCancellation

<Class id="qiskit.transpiler.passes.CommutativeInverseCancellation" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py#L23-L163" signature="qiskit.transpiler.passes.CommutativeInverseCancellation(*args, **kwargs)" modifiers="class">
  ...
  *   **max\_qubits** – Limits the number of qubits in matrix-based commutativity and inverse checks.
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/commutative_inverse_cancellation.py#L95-L163" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CommutativeInverseCancellation.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
