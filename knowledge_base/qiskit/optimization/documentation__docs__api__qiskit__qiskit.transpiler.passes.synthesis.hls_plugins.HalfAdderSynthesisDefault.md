...
source_path: docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault.mdx
license: CC-BY-SA-4.0
---

# HalfAdderSynthesisDefault

<Class id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1817-L1864" signature="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault" modifiers="class">
  ...
  *   `num_clean_ancillas`: The number of clean auxiliary qubits available.
  ...
  <Function id="qiskit.transpiler.passes.synthesis.hls_plugins.HalfAdderSynthesisDefault.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/synthesis/hls_plugins.py#L1837-L1864" signature="run(high_level_object, coupling_map=None, target=None, qubits=None, **options)">
