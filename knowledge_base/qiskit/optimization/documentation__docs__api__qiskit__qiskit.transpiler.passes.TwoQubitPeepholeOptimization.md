...
source_path: docs/api/qiskit/qiskit.transpiler.passes.TwoQubitPeepholeOptimization.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.TwoQubitPeepholeOptimization.mdx
license: CC-BY-SA-4.0
---

# TwoQubitPeepholeOptimization

<Class id="qiskit.transpiler.passes.TwoQubitPeepholeOptimization" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/two_qubit_peephole.py#L24-L126" signature="qiskit.transpiler.passes.TwoQubitPeepholeOptimization(*args, **kwargs)" modifiers="class">
  ...
  ![Optimized circuit](/docs/images/api/qiskit/qiskit-transpiler-passes-TwoQubitPeepholeOptimization-1.avif)
  ...
  *   **approximation\_degree** – heuristic dial used for circuit approximation (1.0=no approximation, 0.0=maximal approximation). Approximation can decrease the number of gates used in the synthesized unitaries smaller at the cost of straying from the original unitary. If `None`, approximation is done based on gate fidelities specified in the `target`.
  ...
  <Function id="qiskit.transpiler.passes.TwoQubitPeepholeOptimization.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.TwoQubitPeepholeOptimization.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.TwoQubitPeepholeOptimization.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/two_qubit_peephole.py#L121-L126" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.TwoQubitPeepholeOptimization.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
