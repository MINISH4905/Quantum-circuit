...
source_path: docs/api/qiskit/qiskit.transpiler.passes.CollectAndCollapse.mdx
source_url: https://github.com/Qiskit/documentation/blob/1a3b8eb3e102668f9612ac64c80f384b28683681/docs/api/qiskit/qiskit.transpiler.passes.CollectAndCollapse.mdx
license: CC-BY-SA-4.0
---

# CollectAndCollapse

<Class id="qiskit.transpiler.passes.CollectAndCollapse" isDedicatedPage={true} github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/collect_and_collapse.py#L23-L88" signature="qiskit.transpiler.passes.CollectAndCollapse(*args, **kwargs)" modifiers="class">
  ...
  *   **do\_commutative\_analysis** ([*bool*](https://docs.python.org/3/library/functions.html#bool)) – if True, exploits commutativity relations between nodes.
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.execute" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L162-L181" signature="execute(passmanager_ir, state, callback=None)">
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.name" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/passmanager/base_tasks.py#L72-L74" signature="name()">
    Name of the pass.
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.run" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/passes/optimization/collect_and_collapse.py#L65-L88" signature="run(dag)">
  ...
  <Function id="qiskit.transpiler.passes.CollectAndCollapse.update_status" github="https://github.com/Qiskit/qiskit/tree/stable/2.5/qiskit/transpiler/basepasses.py#L183-L191" signature="update_status(state, run_state)">
