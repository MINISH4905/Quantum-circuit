...
api_version: 2.5.2
doc_type: api
source_path: qiskit/qasm2/__init__.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/qasm2/__init__.py
license: Apache-2.0
---

## Module `qiskit/qasm2/__init__.py`
...
```python
def loads(string: str, *, include_path: Iterable[str | os.PathLike]=('.',), custom_instructions: Iterable[CustomInstruction]=(), custom_classical: Iterable[CustomClassical]=(), strict: bool=False) -> QuantumCircuit
```
...
```python
def load(filename: str | os.PathLike, *, include_path: Iterable[str | os.PathLike]=('.',), include_input_directory: Literal['append', 'prepend'] | None='append', custom_instructions: Iterable[CustomInstruction]=(), custom_classical: Iterable[CustomClassical]=(), strict: bool=False) -> QuantumCircuit
```
