...
api_version: 2.5.2
doc_type: api
source_path: qiskit/primitives/base/base_estimator.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/primitives/base/base_estimator.py
license: Apache-2.0
---

## Module `qiskit/primitives/base/base_estimator.py`
...
```python
def run(self, circuits: Sequence[QuantumCircuit] | QuantumCircuit, observables: Sequence[BaseOperator | str] | BaseOperator | str, parameter_values: Sequence[Sequence[float]] | Sequence[float] | float | None=None, **run_options) -> T
```
