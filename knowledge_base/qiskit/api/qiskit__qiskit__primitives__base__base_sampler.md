...
api_version: 2.5.2
doc_type: api
source_path: qiskit/primitives/base/base_sampler.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/primitives/base/base_sampler.py
license: Apache-2.0
---

## Module `qiskit/primitives/base/base_sampler.py`
...
```python
def run(self, pubs: Iterable[SamplerPubLike], *, shots: int | None=None) -> BasePrimitiveJob[PrimitiveResult[SamplerPubResult]]
```
