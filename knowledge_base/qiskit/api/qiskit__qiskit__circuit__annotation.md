...
api_version: 2.5.2
doc_type: api
source_path: qiskit/circuit/annotation.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/circuit/annotation.py
license: Apache-2.0
---

## Module `qiskit/circuit/annotation.py`
...
```python
def dump_annotation(self, namespace: str, annotation: Annotation) -> bytes | Literal[NotImplemented]
```
