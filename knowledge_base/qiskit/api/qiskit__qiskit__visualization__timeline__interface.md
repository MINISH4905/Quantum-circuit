...
api_version: 2.5.2
doc_type: api
source_path: qiskit/visualization/timeline/interface.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/visualization/timeline/interface.py
license: Apache-2.0
---

## Module `qiskit/visualization/timeline/interface.py`
...
```python
def draw(program: circuit.QuantumCircuit, style: dict[str, Any] | None=None, time_range: tuple[int, int] | None=None, disable_bits: list[types.Bits] | None=None, show_clbits: bool | None=None, idle_wires: bool | None=None, plot_barriers: bool | None=None, show_delays: bool | None=None, show_labels: bool=True, plotter: str | None=types.Plotter.MPL.value, axis: Any | None=None, filename: str | None=None, target: Target | None=None, *, show_idle: bool | None=None, show_barriers: bool | None=None)
```
