...
api_version: 2.5.2
doc_type: api
source_path: qiskit/circuit/library/grover_operator.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/circuit/library/grover_operator.py
license: Apache-2.0
---

## Module `qiskit/circuit/library/grover_operator.py`
...
```python
def grover_operator(oracle: QuantumCircuit | Statevector, state_preparation: QuantumCircuit | None=None, zero_reflection: QuantumCircuit | DensityMatrix | Operator | None=None, reflection_qubits: list[int] | None=None, insert_barriers: bool=False, name: str='Q')
```
...
```python
def __init__(self, oracle: QuantumCircuit | Statevector, state_preparation: QuantumCircuit | None=None, zero_reflection: QuantumCircuit | DensityMatrix | Operator | None=None, reflection_qubits: list[int] | None=None, insert_barriers: bool=False, mcx_mode: str='noancilla', name: str='Q') -> None
```
