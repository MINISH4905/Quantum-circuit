...
api_version: 2.5.2
doc_type: api
source_path: qiskit/qasm3/__init__.py
source_url: https://github.com/Qiskit/qiskit/blob/c1c01ada399af13e495c27b9b22b4ff942bbad7e/qiskit/qasm3/__init__.py
license: Apache-2.0
---

## Module `qiskit/qasm3/__init__.py`
...
```python
def load(filename: str, *, num_qubits: int | None=None, annotation_handlers: dict[str, annotation.OpenQASM3Serializer] | None=None) -> QuantumCircuit
```
...
```python
def loads(program: str, *, num_qubits: int | None=None, annotation_handlers: dict[str, annotation.OpenQASM3Serializer] | None=None) -> QuantumCircuit
```
...
```python
def dumps_experimental(circuit, *, includes=None, basis_gates=None, disable_constants=True, alias_classical_registers=False, allow_aliasing=False, indent='  ')
```
...
```python
def dump_experimental(circuit, stream, *, includes=None, basis_gates=None, disable_constants=True, alias_classical_registers=False, allow_aliasing=False, indent='  ')
```
