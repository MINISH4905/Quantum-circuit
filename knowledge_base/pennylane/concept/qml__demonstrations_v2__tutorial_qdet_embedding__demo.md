...
doc_type: concept
source_path: demonstrations_v2/tutorial_qdet_embedding/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_qdet_embedding/demo.py
license: Apache-2.0
---
...
exact removal of double counting corrections at the `GW <https://en.wikipedia.org/wiki/GW_approximation>`__
level of theory thus removing the
