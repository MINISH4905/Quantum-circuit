...
doc_type: concept
source_path: demonstrations_v2/tutorial_mbqc/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_mbqc/demo.py
license: Apache-2.0
---
...
MBQC framework. We will do so by using the :doc:`surface code <demos/intro_to_surface_code>` [#FowlerSurfaceCode]_ [#FowlerPolyestimate]_ [#GoogleQEC2022]_ as an example. This code makes use of stabilizers of the form :math:`\bigotimes_i X_i` or 
