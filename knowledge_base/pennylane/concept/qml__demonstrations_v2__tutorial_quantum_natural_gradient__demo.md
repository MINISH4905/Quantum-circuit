...
doc_type: concept
source_path: demonstrations_v2/tutorial_quantum_natural_gradient/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_quantum_natural_gradient/demo.py
license: Apache-2.0
---
...
`Concepts section <https://pennylane.ai/glossary/#variational-circuits>`__, in variational quantum algorithms
...
and :doc:`quantum neural networks (QNN) <demos/quantum_neural_net>`.
