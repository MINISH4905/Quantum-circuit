...
doc_type: concept
source_path: demonstrations_v2/tutorial_dmet_embedding/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_dmet_embedding/demo.py
license: Apache-2.0
---
...
1) Construct an impurity Hamiltonian.
2) Solve the impurity Hamiltonian.
3) Compute the full system energy.
4) Update the interactions between the impurity and its environment.
...
this problem is to use a quantum algorithm as our accurate solver. We now :doc:`map our impurity Hamiltonian to a qubit Hamiltonian <demos/tutorial_mapping>`
...
This Hamiltonian can be used in a quantum algorithm such as :doc:`quantum phase estimation <demos/tutorial_qpe>`.
...
A relevant example is the investigation of core-level excited states in :doc:`X-ray Absorption Spectroscopy (XAS)  <demos/tutorial_xas>`,
