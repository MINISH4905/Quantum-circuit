...
doc_type: concept
source_path: demonstrations_v2/tutorial_qram/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_qram/demo.py
license: Apache-2.0
---
...
Many quantum algorithms that promise advantage or speedup (e.g., in `quantum machine learning <https://pennylane.ai/quantum-machine-learning>`__, :doc:`search <demos/tutorial_grovers_algorithm>`,
