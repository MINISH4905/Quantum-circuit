...
doc_type: concept
source_path: demonstrations_v2/tutorial_implicit_diff_susceptibility/demo.py
source_url: https://github.com/PennyLaneAI/qml/blob/cf4629f869bf4dbc8ce0f9a5a3256eda138c7bbb/demonstrations_v2/tutorial_implicit_diff_susceptibility/demo.py
license: Apache-2.0
---
...
.. meta::
   :property="og:description": Implicitly differentiating the solution of a VQA in PennyLane.
...
def ground_state_solution_map_variational(a, z_init):
    ...
    def loss(z, a):
        ...
        """
        return energy(z, a) + 0.001 * jnp.sum(jnp.abs(z[0])) + 0.001 * jnp.sum(jnp.abs(z[1]))
