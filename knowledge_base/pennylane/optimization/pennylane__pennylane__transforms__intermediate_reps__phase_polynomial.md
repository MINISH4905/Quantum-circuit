...
source_path: pennylane/transforms/intermediate_reps/phase_polynomial.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/transforms/intermediate_reps/phase_polynomial.py
license: Apache-2.0
---

## Module `pennylane/transforms/intermediate_reps/phase_polynomial.py`
...
```python
def phase_polynomial(circ: QuantumScript, wire_order: Sequence | None=None) -> tuple[tuple[TensorLike, TensorLike, TensorLike], PostprocessingFn]
```
