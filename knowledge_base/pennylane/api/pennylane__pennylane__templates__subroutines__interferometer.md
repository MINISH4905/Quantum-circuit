...
api_version: v0.45.1
doc_type: api
source_path: pennylane/templates/subroutines/interferometer.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/templates/subroutines/interferometer.py
license: Apache-2.0
---

## Module `pennylane/templates/subroutines/interferometer.py`
...
```python
def compute_decomposition(theta, phi, varphi, wires, mesh, beamsplitter)
```
