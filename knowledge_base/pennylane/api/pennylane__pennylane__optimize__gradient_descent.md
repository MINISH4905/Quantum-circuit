...
api_version: v0.45.1
doc_type: api
source_path: pennylane/optimize/gradient_descent.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/optimize/gradient_descent.py
license: Apache-2.0
---

## Module `pennylane/optimize/gradient_descent.py`
...
Compute the gradient of the objective function at the given point and return it along with
...
Update the variables to take a single optimization step. Flattens and unflattens
