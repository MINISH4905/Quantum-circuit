...
api_version: v0.45.1
doc_type: api
source_path: pennylane/pulse/rydberg.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/pulse/rydberg.py
license: Apache-2.0
---

## Module `pennylane/pulse/rydberg.py`
...
```python
def rydberg_interaction(register: list, wires=None, interaction_coeff: float=862690, max_distance: float=np.inf)
```

Returns a :class:`ParametrizedHamiltonian` representing the interaction of an ensemble of
