...
api_version: v0.45.1
doc_type: api
source_path: pennylane/devices/qubit/initialize_state.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/devices/qubit/initialize_state.py
license: Apache-2.0
---

## Module `pennylane/devices/qubit/initialize_state.py`
...
```python
def create_initial_state(wires: qp.wires.Wires | Iterable, prep_operation: qp.operation.StatePrepBase=None, like: str=None)
```
