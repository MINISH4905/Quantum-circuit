...
api_version: v0.45.1
doc_type: api
source_path: pennylane/ops/qubit/special_unitary.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/ops/qubit/special_unitary.py
license: Apache-2.0
---

## Module `pennylane/ops/qubit/special_unitary.py`
...
Compute all elements of the Pauli basis of the Lie algebra :math:`\mathfrak{su}(N)`
...
Compute all :math:`n`-qubit Pauli words except ``"I"*num_wires``,
...
Gate from the group :math:`SU(N)` with :math:`N=2^n` for :math:`n` qubits.
...
```python
def get_one_parameter_generators(self, interface: Literal[None, 'jax', 'tensorflow', 'tf', 'torch']=None) -> TensorLike
```
