...
api_version: v0.45.1
doc_type: api
source_path: pennylane/workflow/interfaces/autograd.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/workflow/interfaces/autograd.py
license: Apache-2.0
---

## Module `pennylane/workflow/interfaces/autograd.py`
...
```python
def autograd_execute(tapes: QuantumScriptBatch, execute_fn: ExecuteFn, jpc: qp.workflow.jacobian_products.JacobianProductCalculator, device=None)
```
...
```python
def vjp(ans, parameters, tapes, execute_fn, jpc)
```
