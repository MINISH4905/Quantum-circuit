...
api_version: v0.45.1
doc_type: api
source_path: pennylane/liealg/structure_constants.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/liealg/structure_constants.py
license: Apache-2.0
---

## Module `pennylane/liealg/structure_constants.py`
...
```python
def structure_constants(g: list[Operator | PauliWord | PauliSentence], pauli: bool=False, matrix: bool=False, is_orthogonal: bool=True) -> TensorLike
```
...
.. seealso:: :func:`~lie_closure`, :func:`~center`, :class:`~pennylane.pauli.PauliVSpace`,
