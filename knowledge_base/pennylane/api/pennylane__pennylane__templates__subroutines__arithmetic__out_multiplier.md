...
api_version: v0.45.1
doc_type: api
source_path: pennylane/templates/subroutines/arithmetic/out_multiplier.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/templates/subroutines/arithmetic/out_multiplier.py
license: Apache-2.0
---

## Module `pennylane/templates/subroutines/arithmetic/out_multiplier.py`
...
```python
def compute_decomposition(x_wires: WiresLike, y_wires: WiresLike, output_wires: WiresLike, mod, work_wires: WiresLike)
```
