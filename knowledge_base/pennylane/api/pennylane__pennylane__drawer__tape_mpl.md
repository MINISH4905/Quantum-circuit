...
api_version: v0.45.1
doc_type: api
source_path: pennylane/drawer/tape_mpl.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/drawer/tape_mpl.py
license: Apache-2.0
---

## Module `pennylane/drawer/tape_mpl.py`
...
```python
def tape_mpl(tape: QuantumScript, wire_order: Sequence | None=None, show_all_wires: bool=False, decimals: int | None=None, style: str | None=None, *, fig: mpl.figure.Figure | None=None, max_length: int | None=None, **kwargs)
```
