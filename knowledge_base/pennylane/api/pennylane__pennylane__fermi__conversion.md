...
api_version: v0.45.1
doc_type: api
source_path: pennylane/fermi/conversion.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/fermi/conversion.py
license: Apache-2.0
---

## Module `pennylane/fermi/conversion.py`
...
```python
def jordan_wigner(fermi_operator: FermiWord | FermiSentence, ps: bool=False, wire_map: dict=None, tol: float=None) -> Operator | PauliSentence
```
...
```python
def parity_transform(fermi_operator: FermiWord | FermiSentence, n: int, ps: bool=False, wire_map: dict=None, tol: float=None) -> Operator | PauliSentence
```
...
```python
def bravyi_kitaev(fermi_operator: FermiWord | FermiSentence, n: int, ps: bool=False, wire_map: dict=None, tol: float=None) -> Operator | PauliSentence
```
