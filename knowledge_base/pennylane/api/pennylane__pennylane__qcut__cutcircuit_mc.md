...
api_version: v0.45.1
doc_type: api
source_path: pennylane/qcut/cutcircuit_mc.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/qcut/cutcircuit_mc.py
license: Apache-2.0
---

## Module `pennylane/qcut/cutcircuit_mc.py`
...
```python
def cut_circuit_mc(tape: QuantumScript, classical_processing_fn: Callable | None=None, auto_cutter: bool | Callable=False, max_depth: int=1, device_wires: Wires | None=None, **kwargs) -> tuple[QuantumScriptBatch, PostprocessingFn]
```
...
```python
def expand_fragment_tapes_mc(tapes: QuantumScriptBatch, communication_graph, shots: int, seed=None) -> tuple[QuantumScriptBatch, np.ndarray]
```
