...
api_version: v0.45.1
doc_type: api
source_path: pennylane/debugging/snapshot.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/debugging/snapshot.py
license: Apache-2.0
---

## Module `pennylane/debugging/snapshot.py`
...
This transform processes :class:`~pennylane.Snapshot` instances contained in a circuit,
