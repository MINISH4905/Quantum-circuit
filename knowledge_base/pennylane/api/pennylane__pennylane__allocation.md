...
api_version: v0.45.1
doc_type: api
source_path: pennylane/allocation.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/allocation.py
license: Apache-2.0
---

## Module `pennylane/allocation.py`
...
```python
def from_num_wires(cls, num_wires: int, state: AllocateState=AllocateState.ZERO, restored=False) -> 'Allocate'
```
...
```python
def allocate(num_wires: int, state: Literal['any', 'zero'] | AllocateState=AllocateState.ZERO, restored: bool=False) -> DynamicRegister
```
