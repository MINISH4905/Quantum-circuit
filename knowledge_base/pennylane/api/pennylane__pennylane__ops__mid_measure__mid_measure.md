...
api_version: v0.45.1
doc_type: api
source_path: pennylane/ops/mid_measure/mid_measure.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/ops/mid_measure/mid_measure.py
license: Apache-2.0
---

## Module `pennylane/ops/mid_measure/mid_measure.py`
...
```python
def measure(wires: Hashable | Wires, reset: bool=False, postselect: int | None=None) -> MeasurementValue
```
