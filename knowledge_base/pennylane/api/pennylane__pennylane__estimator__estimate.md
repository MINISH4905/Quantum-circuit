...
api_version: v0.45.1
doc_type: api
source_path: pennylane/estimator/estimate.py
source_url: https://github.com/PennyLaneAI/pennylane/blob/5f61ce25df3cc28a1ac785d20e47d70761202ed2/pennylane/estimator/estimate.py
license: Apache-2.0
---

## Module `pennylane/estimator/estimate.py`
...
```python
def estimate(workflow: Callable | ResourceOperator | Resources | QNode, gate_set: set[str] | None=None, zeroed_wires: int=0, any_state_wires: int=0, tight_wires_budget: bool=False, config: ResourceConfig | None=None) -> Resources | Callable[..., Resources]
```
