...
api_version: v1.7.0
doc_type: api
source_path: cirq-core/cirq/experiments/n_qubit_tomography.py
source_url: https://github.com/quantumlib/Cirq/blob/de651a7886d1a1383d595f95f36b93ed3ea91685/cirq-core/cirq/experiments/n_qubit_tomography.py
license: Apache-2.0
---

## Module `cirq-core/cirq/experiments/n_qubit_tomography.py`
...
```python
def __init__(self, qubits: Sequence[cirq.Qid], prerotations: Sequence[tuple[float, float]] | None=None)
```
...
```python
def state_tomography(sampler: cirq.Sampler, qubits: Sequence[cirq.Qid], circuit: cirq.Circuit, repetitions: int=1000, prerotations: Sequence[tuple[float, float]] | None=None) -> TomographyResult
```
